...
public class LukoilAutoplinTest extends TestCase {
    ...
    @Test
    public void test_01_getLukoilAutoplin() throws Exception 
    {
    	String kategorija = "Autoplin";
    	String distributeri = "Lukoil";
    	String autocesta = "DA";
